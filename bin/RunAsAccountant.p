...
DEFINE NEW GLOBAL SHARED VARIABLE session_UsersName AS CHARACTER INIT "Accountant".
DEFINE NEW GLOBAL SHARED VARIABLE session_User AS CHARACTER INIT "Accountant".
